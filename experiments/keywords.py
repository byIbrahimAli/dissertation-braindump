...
with open(result, 'w', newline='') as file2:
    for specific_column_in_data in data :
        ...
        csvwriter.writerow(["'" + specific_column_in_data[0] + "': HighlightedWord( onTap: () => print('" + specific_column_in_data[0] + "'), textStyle: const TextStyle(color: Colors." + specific_column_in_data[1] + ", fontWeight: FontWeight.w600, fontSize: 20,),),"])
